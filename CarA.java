...
public class CarA extends JPanel{
   ...
   private JTextArea display5 = new JTextArea("Thank you for buying car");
   private JTextArea display6 = new JTextArea("Copyright © 2018, Stuxnet Cyber Security Corporation.");
   ...
   public CarA() {
    ...
    btnSubmit.addActionListener(new clearBottomPanel8());
    panel.add(btnSubmit);
