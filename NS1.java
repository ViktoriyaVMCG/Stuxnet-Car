...
import javax.swing.*;
public class NS1 extends JPanel{
   private JLabel label;
   private JButton btnSubmit;
   private JFrame frame = new JFrame();
   private JTextArea display5 = new JTextArea("            Nissan Versa 2018");
   ...
   public NS1() {
    ...
    ImageIcon icon8 = new ImageIcon("image/NissanVersa.png");
    ...
    panel.add(display5); 
      ...
      label = new JLabel();
      label.setText("Price:$12,110    Miles:8,269");      
