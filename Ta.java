...
public class Ta extends JPanel{
   ...
   private JTextArea display5 = new JTextArea("      Toyota Camry Hybrid 2018");
   private JTextArea display6 = new JTextArea("Copyright © 2018, Stuxnet Business Services.");
   private JPanel panel = new JPanel();
   
   public Ta() {
    JFrame.setDefaultLookAndFeelDecorated(true);
    frame.setTitle("Toyota Camry Hybrid 2018");
    frame.setSize(650, 600);
    frame.setResizable(false);
    frame.setLayout(new BorderLayout());
    frame.add(panel, BorderLayout.CENTER);
    
    ImageIcon icon8 = new ImageIcon("image/Cam.png");
    ...
    panel.add(display5); 
      ...
      label = new JLabel();
      label.setText("Price:$27,000    Miles:3,087");      
