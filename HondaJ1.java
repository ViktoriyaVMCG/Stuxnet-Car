...
import javax.swing.*;
public class HondaJ1 extends JPanel{
   private JLabel label;
   private JButton btnSubmit;
   private JFrame frame = new JFrame();
   private JTextArea display5 = new JTextArea("             Honda HR-V 2018");
   private JTextArea display6 = new JTextArea("Copyright © 2018, Stuxnet Business Services.");
   private JPanel panel = new JPanel();
   
   public HondaJ1(){
    JFrame.setDefaultLookAndFeelDecorated(true);
    frame.setTitle("Honda HR-V 2018");
    frame.setSize(650, 600);
    frame.setResizable(false);
    frame.setLayout(new BorderLayout());
    frame.add(panel, BorderLayout.CENTER);
    
    ImageIcon icon8 = new ImageIcon("image/HondaHR-V.png");
    ...
    panel.add(display5); 
      ...
      label = new JLabel();
      label.setText("Price:$19,670    Miles:24,393");      
